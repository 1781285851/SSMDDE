				...
				<div class="scrollbar-inner sidebar-wrapper">
					...
					<ul class="nav">
						<li class="nav-item active">
							<a href="${pageScope.basePath}WEB-INF/views/modules/sys/index.jsp">
						...
						<li class="nav-item">
							<a href="${pageScope.basePath}WEB-INF/views/modules/sys/components.jsp">
						...
						<li class="nav-item">
							<a href="${pageScope.basePath}WEB-INF/views/modules/sys/forms.jsp">
						...
						<li class="nav-item">
							<a href="${pageScope.basePath}WEB-INF/views/modules/sys/tables.jsp">
								<i class="la la-th"></i>
								<p>会员</p>
						...
						<li class="nav-item">
							<a href="${pageScope.basePath}WEB-INF/views/modules/sys/notifications.jsp">
								<i class="la la-bell"></i>
								<p>Notifications</p>
						...
						<li class="nav-item">
							<a href="${pageScope.basePath}WEB-INF/views/modules/sys/typography.jsp">
						...
						<li class="nav-item">
							<a href="${pageScope.basePath}WEB-INF/views/modules/sys/icons.jsp">
